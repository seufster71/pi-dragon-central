...
public class PiController {
	...
	final GpioPinDigitalOutput gpio0 = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_00,"SW0", PinState.HIGH);
	final GpioPinDigitalOutput gpio1 = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_01,"SW1", PinState.HIGH);
	...
	final GpioPinDigitalOutput gpio8 = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_08,"SW8", PinState.HIGH);
	final GpioPinDigitalOutput gpio9 = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_09,"SW9", PinState.HIGH);
	...
	public PiController() {
		gpioMap.put("fan-1-1", gpio0);
		gpioMap.put("fan-1-2", gpio1);
		...
		gpioMap.put("open-1", gpio8);
		gpioMap.put("open-2", gpio9);
